...
public class AppContainer {
    ...
    public AppContainer(Context context){
        ...
        repository = NutrifitRepository.getInstance(database.userItemDao(), database.weightRecordItemDao(), database.plantillaItemDao(), recipesNetworkDataSource, excercisesNetworkDataSource);
