...
public class DetallesHorarioAdapter extends RecyclerView.Adapter<DetallesHorarioAdapter.ViewHolder> {
    ...
    public DetallesHorarioAdapter(OnDeleteClickListener deleteListener, OnItemClickListener listener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final CalendarDayItem calendarDayItem, final OnDeleteClickListener deleteListener, final OnItemClickListener listener) {
